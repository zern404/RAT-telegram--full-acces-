...
<h2>Теперь установите зависимости: pip install pyautogui webbrowser psutil win32crypt opencv-python aiofiles mss numpy pyaudio aiogram pycryptodome pyinstaller colorama mouse keyboard</h2>
